...
const Modal = ({ onClose, setOpenSnackbarShare }: any) => {
  ...
  return (
    <div className={`fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center`} style={{ backdropFilter: 'blur(2px)' }} onClick={handleOverlayClick}>
    ...
    <div className="w-full h-full flex flex-row bg-white">
      ...
      <div className="w-full md:w-6/7">
        <main className="h-screen flex-col w-full bg-gray-100 bg-opacity-50 pl-2 pr-6 pt-5 pb-6 overflow-hidden text-gray-700">
          ...
          {isModalOpen && <Modal setOpenSnackbarShare={setOpenSnackbarShare} onClose={handleCloseModal} />}
          <Snackbar
            key={`4`}
