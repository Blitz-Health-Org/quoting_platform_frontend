  ...
  return (
    ...
    <p className="text-sm mr-2 font-bold">Family</p>
        ...
        {!editStandardContributions && (
            <button onClick={handleEdit} className="mr-2 outline outline-1 outline-gray-300 hover:outline-gray-400/80 shadow-sm px-2 py-0.5 rounded-sm mt-1 hover:bg-slate-200/50 hover:shadow w-full">
        ...
        {editStandardContributions && (
            <button onClick={handleSave} className="mr-2 outline outline-1 outline-gray-300 hover:outline-gray-400/80 shadow-sm px-2 py-0.5 rounded-sm mt-1 hover:bg-slate-200/50 bg-gray-100 w-full">
            <div className="flex items-center gap-2 justify-center">
                <FaSave/>
                <p>Save</p>
            </div>
