...
export function GroupCard({
  ...
  return (
    <div className="flex-col w-fit bg-white border border-b-0 rounded-b-none border-gray-300 rounded-md">
      <div className="flex bg-white  w-full gap-3 h-28 justify-center items-center px-2">
