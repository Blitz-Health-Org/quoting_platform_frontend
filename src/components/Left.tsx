...
export default function Left() {
  ...
  return (
    ...
    {itemList.map((item: any, index: any) => (
      <div key={index}>
        ...
        <div className="flex items-center h-7 bg-violet-100/60 w-full">
          <p className="ml-4 font-semibold">{item}</p>
        </div>
      </div>
    ))}
    ...
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Visit to Provider</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Test</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Drugs</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Outpatient Surgery</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Need Immediate Attention</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Hospital Stay</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Mental/Behavioral/SUD</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Other Special Health Needs</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Premiums/Enrollment</p>
    </div>
    ...
    <hr className="w-full border-t-1 border-gray-500"></hr>
    <div className="flex items-center h-7 bg-violet-100/60 w-full">
        <p className="ml-4 font-semibold">Total Cost</p>
    </div>
    </div>
  </div>
